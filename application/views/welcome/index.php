...
<div class="container-fluid">
	...
	<form class='col-lg-10 mx-auto' name="add" action="<?php echo base_url('welcome/add') ?>" method="post" enctype="multipart/form-data">
	...
	<div class='error text-center mb-3 text-danger'>
		...
		<div class='row mb-3 inline motivasi'>
			<div class="col-lg-4 p-0 m-0 h-100"><div class='align-middle'><label for="motivasi">Apa motivasi Anda untuk melakukan olahraga?</label></div></div>
			<div class="col-lg-8 mx-auto ">
				<div class="form-check">
					<input class="form-check-input" type="checkbox" id="mtv1" value="Saya ingin menjadi lebih fit" name="motivasi[]">
					<label class="form-check-label" for="mtv1">
					Saya ingin menjadi lebih fit
					</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" type="checkbox" id="mtv2" value="Saya ingin menjadi lebih fleksibel" name="motivasi[]" >
					<label class="form-check-label" for="mtv2">
					Saya ingin menjadi lebih fleksibel
					</label>
				</div><div class="form-check">
					<input class="form-check-input" type="checkbox" id="mtv3" value="Saya ingin melepas stress" name="motivasi[]">
					<label class="form-check-label" for="mtv3">
					Saya ingin melepas stress
					</label>
				</div><div class="form-check">
					<input class="form-check-input" type="checkbox" id="mtv4" value="Saya ingin meningkatkan massa otot dan kekuatan" name="motivasi[]">
					<label class="form-check-label" for="mtv4">
					Saya ingin meningkatkan massa otot dan kekuatan
					</label>
				</div><div class="form-check">
					<input class="form-check-input" type="checkbox" id="mtv5" value="Saya ingin menurunkan berat badan" name="motivasi[]">
		...
		<div class='mb-3 row olahraga'>
			<div class="col-lg-4 p-0 m-0"><label for="olahraga">Olahraga yang Anda sedang atau senang jalani?</label></div>
			<div class='row col-lg-8 p-0 m-0'>
				<div class="col-lg-4">
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox" value="Berjalan atau Jogging" name="olahraga[]" id="olg3">
					...
					<div class="form-check">
						...
						<input class="form-check-input" type="checkbox" value="Futsal/Sepak Bola" name="olahraga[]" id="olg6">
			...
			<div class='row col-lg-8 p-0 m-0'>
				...
				<div class="col-lg-3">
					<div class="form-check">
						...
						<input class="form-check-input" type="checkbox" value="Penyakit Ginjal" name="penyakit[]" id="pny6">
				...
				<div class="col-lg-4">
					<div class="form-check">
						<input class="form-check-input" type="checkbox" value="Tekanan Darah Rendah" name="penyakit[]" id="pny7">
						<label class="form-check-label" for="pny7">
						Tekanan Darah Rendah
						</label>
					</div><div class="form-check">
						<input class="form-check-input" type="checkbox" value="Tekanan Darah Tinggi" name="penyakit[]" id="pny8">
